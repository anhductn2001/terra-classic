...
test-e2e-ci:
	@VERSION=$(VERSION) TERRA_E2E=True TERRA_E2E_DEBUG_LOG=False  go test -mod=readonly -timeout=25m -v $(PACKAGES_E2E)
...
docker-build-debug:
	@DOCKER_BUILDKIT=1 docker build -t terra:${COMMIT} --build-arg BASE_IMG_TAG=debug -f Dockerfile .
